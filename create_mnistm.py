...
train = create_mnistm((x_train_A>0).astype(np.uint8) * 255)
print('Building test set...')
test = create_mnistm((x_test_A>0).astype(np.uint8) * 255)
print('Building validation set...')
valid = create_mnistm((x_test_A>0).astype(np.uint8) * 255)
